...
public static void main(String[] args) {
    ...
    public void Finder() {
         ...
         try {
            ...
            URI uri = new URI("https://www.milton.edu/");
            URL url = uri.toURL();
                    ...
                    if (line.contains("href=")) {
                        ...
                        if (start < line.length()) {
                            ...
                            if (end != -1 || !urlC.substring(0, 2).equals("//")) {
                                System.out.println(urlC.substring(0, end));
                            }
                            else if (end != -1 || urlC.substring(0, 2).equals("//")) {
                                System.out.println(urlC.substring(2, end));
                            }
                        }
                    }
